...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Práctica 6: alimentos}
  spec.description   = %q{Práctica sobre la información nutricional de un producto específico}
  spec.homepage      = "https://github.com/ULL-ESIT-LPP-1718/tdd-alu0100945645.git"
  spec.license       = "MIT"
